...
if (empty($_POST['email'])) {
    ...
    header("Location: http://localhost:3000/Login/Email");
} else if (empty($_POST['pass'])) {

    header("Location: http://localhost:3000/Login/Senha");
} else {
    ...
    if (isset($result)) {
        ...
        header("Location: http://localhost:3000/Cadastro/Email_não_cadastrado");
    }
}
